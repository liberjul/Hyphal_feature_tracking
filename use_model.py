...
# Path to image files
PATH_TO_IMS = "./test_ims/"
# Path to directory to store annotated images
PATH_TO_ANNOT_IMS= "./model_annots/"
# Frame length and width in um, depends on microscope and magnification
FRAME_LENGTH, FRAME_WIDTH = (1319.9,989.9)
